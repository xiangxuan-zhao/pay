...
public class BestPayConfig {
    ...
    public BestPayService bestPayService(WxPayConfig wxPayConfig){
        ...
        aliPayConfig.setNotifyUrl("http://z26-xuan.natapp1.cc/pay/notify");
        aliPayConfig.setReturnUrl("127.0.0.1");
    ...
    public WxPayConfig wxPayConfig() {
        ...
        wxPayConfig.setNotifyUrl("http://z26-xuan.natapp1.cc/pay/notify");
        return wxPayConfig;
    }
}
